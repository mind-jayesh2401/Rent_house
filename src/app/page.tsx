    ...
    >
      <section className="bg-white max-w-[1920px] w-full mx-auto">
        ...
        <div className="mt-44 max-w-full px-40 w-full mx-auto flex">
          <div className="w-3/5 max-w-full  pt-10 ">
            <h2
            ...
            <button className="px-5 py-1 border-2 rounded-full text-[#A0CCA1] mt-10 uppercase border-[#A0CCA1]">
              Tap to purchase
            </button>
            <div className="relative">
              <img
                src="/image 2.png"
                alt="grass"
                className="absolute -right-64 -top-28 z-[2]"
              />
              <img src="/image 3.png" alt="grass" className="invisible" />
              <img
                src="/image 3.png"
                alt="grass"
                className="absolute -right-6 -top-11 z-[1] "
              />
            </div>
          </div>
        ...
        <footer className="flex justify-between items-center  max-w-full px-40 w-full mx-auto ">
          <div className="flex">
            <div>
              <svg
